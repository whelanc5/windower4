...
-- All modes should have a "Default" entry
	...
	sets.precast.Quickdraw = {right_ear="Friomisi Earring",left_ear = "Hecate's Earring", head="Mummu Bonnet +1",
    body="Meg. Cuirie +2",
    hands="Mummu Wrists +2",
    legs="Mummu Kecks +1",
    feet="Mummu Gamash. +1",
    ...
    sets.TP.Acc = set_combine(sets.TP,{ head="Meghanada Visor +1",  body="Meg. Cuirie +2",  feet="Meg. Jam. +1"})
	sets.TP.Haste = set_combine(sets.TP,{body = "Rawhide Vest", waist = "Windbuffet Belt"})	
 	
	
	----------------------------------------------------------------DT-----------------------------------------------------------------------------------------------
	sets.DT = set_combine(sets.base, {head="Meghanada Visor +1",  body="Meg. Cuirie +2",  feet="Meg. Jam. +1", hands="Meg. Gloves +2", left_ring="Meghanada Ring"})
	...
	----------------------------------------------------------------IDLE---------------------------------------------------------------------------------------------
	sets.Idle = set_combine(sets.base,{head="Meghanada Visor +1",body="Meg. Cuirie +2",hands="Meg. Gloves +2", neck="Bathy Choker",feet="Hermes' Sandals"}) -- base set for idle
	...
	sets.WS = set_combine(sets.base,{ ammo="Eminent Bullet",head="Meghanada Visor +1", body="Meg. Cuirie +2",hands="Meg. Gloves +2", ear1 ="Moonshade Earring", feet="Meg. Jam. +1",
    neck="Sanctity Necklace",  left_ring="Garuda Ring", right_ring="Hajduk Ring",back= CamulusbackAGI, waist = "Kwahu Kachina Belt"})--base set for weaponskill that isn't named
	sets.precast.WS = sets.WS -- -- don't change this 
	sets.WS.Default = sets.WS -- don't change this

	sets.WS.Acc = set_combine(sets.WS,{})
	sets.WS['Last Stand'] = set_combine(sets.base,{ ammo="Divine Bullet",head="Meghanada Visor +1", body="Meg. Cuirie +2",hands="Meg. Gloves +2", feet="Meg. Jam. +1"})
	sets.WS['Leaden Salute'] = set_combine(sets.WS, {waist = "Eschan Stone", neck="Sanctity Necklace", head = "Pixie Hairpin +1", right_ring="Apate Ring", right_ear="Friomisi Earring", body = "Rawhide Vest", legs = hercLegsMAB, feet = hercFeetMAB, hands = hercHandsMAB})
	...
	----------------------------------------------------------------Range----------------------------------------------------------------------------------------------
	sets.Ranged = set_combine(sets.base,{ ammo = "Eminent Bullet", head="Meghanada Visor +1",  body="Nisroch Jerkin",  hands="Meg. Gloves +2",   feet="Meg. Jam. +1", left_ring="Apate Ring", right_ring="Hajduk Ring",	 back=CamulusbackAGI, waist = "Kwahu Kachina Belt", neck ='Ocachi Gorget' })
